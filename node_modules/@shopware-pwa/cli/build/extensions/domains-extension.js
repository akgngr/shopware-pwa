...
// src/extensions/domains-extension.ts
var import_axios = __toESM(require_axios2());
var DEFAULT_API_INSTANCE_DOMAINS_SOURCE = "https://gist.githubusercontent.com/mkucmus/51aea54148684f886f8ad0649c95dff6/raw/domains.json";
module.exports = (toolbox) => {
  toolbox.domains = {};
  toolbox.domains.fetchDomainsForSalesChannel = async (shopwareEndpoint, authToken, salesChannelAccessKey) => {
    var _a;
    const fetchDomainsResponse = await import_axios.default.post(`${toolbox.normalizeBaseUrl(shopwareEndpoint)}/api/search/sales-channel-domain`, {
      filter: [
        {
          type: "equals",
    ...
    return (_a = fetchDomainsResponse == null ? void 0 : fetchDomainsResponse.data) == null ? void 0 : _a.data;
  };
  ...
  toolbox.domains.getDefaultDemoDomainsJson = async () => {
    const defaultDomainsJsonResponse = await import_axios.default.get(DEFAULT_API_INSTANCE_DOMAINS_SOURCE);
