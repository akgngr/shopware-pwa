...
var require_delayed_stream = __commonJS({
  "node_modules/axios/node_modules/delayed-stream/lib/delayed_stream.js"(exports, module) {
...
var require_combined_stream = __commonJS({
  "node_modules/axios/node_modules/combined-stream/lib/combined_stream.js"(exports, module) {
    var util = __require("util");
    var Stream = __require("stream").Stream;
...
var require_db = __commonJS({
  "node_modules/axios/node_modules/mime-db/db.json"(exports, module) {
    module.exports = {
...
var require_mime_db = __commonJS({
  "node_modules/axios/node_modules/mime-db/index.js"(exports, module) {
...
var require_mime_types = __commonJS({
  "node_modules/axios/node_modules/mime-types/index.js"(exports) {
    "use strict";
...
var require_defer = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/defer.js"(exports, module) {
...
var require_async = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/async.js"(exports, module) {
...
var require_abort = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/abort.js"(exports, module) {
...
var require_iterate = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/iterate.js"(exports, module) {
...
var require_state = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/state.js"(exports, module) {
...
var require_terminator = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/terminator.js"(exports, module) {
    var abort = require_abort();
    var async = require_async();
...
var require_parallel = __commonJS({
  "node_modules/axios/node_modules/asynckit/parallel.js"(exports, module) {
...
var require_serialOrdered = __commonJS({
  "node_modules/axios/node_modules/asynckit/serialOrdered.js"(exports, module) {
    var iterate = require_iterate();
    var initState = require_state();
    var terminator = require_terminator();
...
var require_serial = __commonJS({
  "node_modules/axios/node_modules/asynckit/serial.js"(exports, module) {
...
var require_asynckit = __commonJS({
  "node_modules/axios/node_modules/asynckit/index.js"(exports, module) {
    module.exports = {
  ...
  "node_modules/axios/node_modules/form-data/lib/form_data.js"(exports, module) {
    ...
    FormData2.prototype._getContentDisposition = function(value, options) {
      ...
      if (typeof options.filepath === "string") {
        ...
        filename = path7.basename(options.filename || value.name || value.path);
...
var require_FormData = __commonJS({
  "node_modules/axios/lib/defaults/env/FormData.js"(exports, module) {
...
async function getCompatibilityTable() {
  try {
    ...
    return merge({}, compatibility_default, gitHubReleasesResponse.data);
  } catch (e) {
...
// packages/nuxt-module/src/utils.ts
async function loadConfig(moduleObject) {
...
import jetpack2 from "fs-jetpack";
function extendCMS(moduleObject, shopwarePwaConfig) {
  const cmsModuleExists = jetpack2.exists(path.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-cms", "cmsNameMapper.js"));
  if (!cmsModuleExists) {
    throw new Error("[shopware-pwa] CMS module is not initialized properly, please run 'shopware-pwa init'");
  }
  const allThemeCmsFiles = jetpack2.list(path.join(shopwarePwaConfig.theme, "cms")) || [];
  const cmsCatalogFiles = allThemeCmsFiles.filter((name) => name.includes(".vue"));
  moduleObject.extendBuild((config) => {
    const swCmsDirectory = path.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-cms");
    cmsCatalogFiles.forEach((cmsFile) => {
      config.resolve.alias["sw-cms/" + cmsFile.replace(".vue", "")] = path.join(shopwarePwaConfig.theme, "cms", cmsFile);
    });
...
import jetpack3 from "fs-jetpack";
async function setupDomains(moduleObject, shopwarePwaConfig) {
  const domainConfigPath = path2.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins", "domains.json");
  const domainsConfigExists = jetpack3.exists(domainConfigPath);
  if (!domainsConfigExists) {
    await jetpack3.writeAsync(domainConfigPath, "{}");
  ...
  const domainsConfigFile = await jetpack3.readAsync(domainConfigPath);
  ...
  const dontUseNamedRoute = (route) => {
    return route?.children?.find((childRoute) => childRoute.path == "");
  };
  ...
  const enrichRoutes = (routes) => {
    ...
    routes.forEach((route) => {
      if (!route.meta?.domainId || !domainsEntries.length) {
        domainsEntries.filter(({ url }) => shopwarePwaConfig.shopwareDomainsAllowList?.includes(url)).forEach((domainConfig) => {
          ...
          if (!domainsRoutes.find((routeData) => routeData.name === routeName)) {
            domainsRoutes.push({
              ...route,
              path: `${domainConfig.pathPrefix !== "/" ? domainConfig.pathPrefix : ""}${route.path}`,
              name: routeName,
              meta: domainConfig || [],
  ...
  moduleObject.addPlugin({
    fileName: "domain.js",
    src: path2.join(__dirname, "..", "plugins", "domain.js"),
    options: {
...
import jetpack4 from "fs-jetpack";
function extendLocales(moduleObject, shopwarePwaConfig) {
  const languageConfigExists = jetpack4.exists(path3.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins", "languages.json"));
  ...
  const defaultLanguageFileExists = jetpack4.exists(path3.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins", "locales", `${defaultLanguageCode}.json`));
  ...
  const localesDirListing = jetpack4.list(path3.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins", "locales")) || [];
  const localeFromFiles = localesDirListing.map((localeFileName) => localeFileName.replace(".json", ""));
  moduleObject.addPlugin({
    src: path3.join(__dirname, "..", "plugins", "i18n.js"),
    fileName: "i18n.js",
    options: {
...
import jetpack5 from "fs-jetpack";
function useCorePackages(moduleObject, corePackages) {
  const useRawSource = (packageName) => {
    const pkgPath = path4.resolve(path4.join("node_modules", packageName));
    const pkg = jetpack5.read(path4.join(pkgPath, "package.json"), "json");
    if (pkg && pkg.module) {
      moduleObject.options.alias[pkg.name + "$"] = path4.resolve(pkgPath, pkg.module);
    }
...
function getTargetSourcePath(moduleObject) {
  return path5.join(moduleObject.options.rootDir, ".shopware-pwa", "source");
}
function getThemeSourcePath(moduleObject, config) {
  const directDistPath = path5.join(moduleObject.options.rootDir, config.theme, "dist");
  const directDistPathExist = fse.existsSync(directDistPath);
  if (directDistPathExist)
    return directDistPath;
  const directPath = path5.join(moduleObject.options.rootDir, config.theme);
  const directPathExist = fse.existsSync(directPath);
  if (directPathExist)
    return directPath;
  const nodePackageDistPath = path5.join(moduleObject.options.rootDir, "node_modules", config.theme, "dist");
  const nodePackageDistPathExist = fse.existsSync(nodePackageDistPath);
  if (nodePackageDistPathExist)
    return nodePackageDistPath;
  const nodePackagePath = path5.join(moduleObject.options.rootDir, "node_modules", config.theme);
...
function getProjectSourcePath(moduleObject) {
  return path5.join(moduleObject.options.rootDir, "src");
}
function filterNodeModules(src, dest) {
  return !dest.includes("node_modules");
}
async function useThemeAndProjectFiles({
  TARGET_SOURCE,
  THEME_SOURCE,
  PROJECT_SOURCE
}) {
  await fse.emptyDir(TARGET_SOURCE);
  const layoutsPath = path5.join(TARGET_SOURCE, "..", "sw-plugins", "layouts");
  const layoutsExist = await fse.pathExists(layoutsPath);
  layoutsExist && await fse.copy(layoutsPath, path5.join(TARGET_SOURCE, "layouts"));
  const pagesPath = path5.join(TARGET_SOURCE, "..", "sw-plugins", "pages");
  const pagesExist = await fse.pathExists(pagesPath);
  pagesExist && await fse.copy(pagesPath, path5.join(TARGET_SOURCE, "pages"));
...
async function onThemeFilesChanged({
  event,
  filePath,
  TARGET_SOURCE,
  THEME_SOURCE,
  ...
  const projectFilePath = path5.join(PROJECT_SOURCE, relativePath);
  const targetFilePath = path5.join(TARGET_SOURCE, relativePath);
...
async function onProjectFilesChanged({
  event,
  filePath,
  TARGET_SOURCE,
  THEME_SOURCE,
  ...
  if (event === "unlink") {
    const baseThemeFilePath = path5.join(THEME_SOURCE, relativePath);
...
// packages/commons/src/getAllFiles.ts
function getAllFiles(dirPath, arrayOfFiles = [], excludeHidden = true) {
  const jetpack6 = __require("fs-jetpack");
  const path7 = __require("path");
  if (!dirPath || !jetpack6.exists(dirPath))
    return [];
  const files = jetpack6.list(dirPath);
  files.forEach((file) => {
    if (jetpack6.exists(path7.join(dirPath, file)) === "dir") {
      arrayOfFiles = getAllFiles(path7.join(dirPath, file), arrayOfFiles);
    } else {
      const fileName = path7.join(dirPath, file).replace(__dirname + "/", "");
      if (!(excludeHidden && file.startsWith("."))) {
        arrayOfFiles.push(path7.normalize(fileName));
      }
    }
  });
  return arrayOfFiles;
...
// packages/nuxt-module/src/module.ts
async function runModule(moduleObject, moduleOptions) {
  ...
  moduleObject.options.alias["@vue/composition-api/dist/vue-composition-api.mjs"] = moduleObject.nuxt.resolver.resolveModule("@vue/composition-api/dist/vue-composition-api.mjs");
  moduleObject.options.alias["@vue/composition-api"] = moduleObject.nuxt.resolver.resolveModule("@vue/composition-api/dist/vue-composition-api.mjs");
  moduleObject.options.alias["@vue/composition-api/dist/vue-composition-api.esm.js"] = moduleObject.nuxt.resolver.resolveModule("@vue/composition-api/dist/vue-composition-api.mjs");
  moduleObject.options.alias["vue"] = moduleObject.options.alias["vue"] || (moduleObject.options.dev ? moduleObject.nuxt.resolver.resolveModule("vue/dist/vue.common.dev.js") : moduleObject.nuxt.resolver.resolveModule("vue/dist/vue.runtime.esm.js"));
  ...
  moduleObject.options.store = vuexState;
  moduleObject.options.features.store = vuexState;
  moduleObject.options.alias["~"] = TARGET_SOURCE;
  moduleObject.options.alias["@"] = TARGET_SOURCE;
  moduleObject.options.alias["assets"] = path6.join(TARGET_SOURCE, "assets");
  moduleObject.options.alias["static"] = path6.join(TARGET_SOURCE, "static");
  ...
  moduleObject.addPlugin({
    src: path6.join(__dirname, "..", "plugins", "entities-parser", "entities-parser.csr.js"),
    fileName: "entities-parser.csr.js",
    mode: "client",
    options: moduleOptions
  });
  moduleObject.addPlugin({
    src: path6.join(__dirname, "..", "plugins", "entities-parser", "entities-parser.ssr.js"),
    fileName: "entities-parser.ssr.js",
    mode: "server",
    options: {}
  });
  const pluginFiles = getAllFiles(path6.join(moduleObject.options.srcDir, "plugins")).filter((filePath) => /.+.(js|ts)$/.test(filePath));
  ...
  pluginFiles.forEach((pluginPath) => {
    ...
    const pluginMode = pluginFilename.match(modePattern)?.filter((mode) => pluginModes.includes(mode) ? mode : void 0)?.[0];
    moduleObject.addPlugin({
      src: pluginPath,
      fileName: pluginFilename,
      mode: pluginMode || void 0,
      options: moduleOptions
    });
    console.info(`"${pluginFilename}" plugin was registered automatically in ${pluginMode ?? "client&server"} mode.`);
  });
  let config = merge2({}, getDefaultApiParams());
  try {
    const defaultsConfigBuilder = __require("@shopware-pwa/nuxt-module/api-defaults").default;
  ...
  moduleObject.addPlugin({
    ...
    src: path6.join(__dirname, "..", "plugins", "api-client.js"),
    options: {
  ...
  moduleObject.addPlugin({
    src: path6.join(__dirname, "..", "plugins", "cookie-universal-nuxt.js"),
    fileName: "cookie-universal-nuxt.js",
    options: Object.assign({}, defaults, moduleOptions)
  });
  moduleObject.addPlugin({
    src: path6.join(__dirname, "..", "plugins", "composition-api.js"),
    fileName: "composition-api.js",
    options: moduleOptions
  });
  moduleObject.extendBuild((config2, ctx) => {
    const swPluginsDirectory = path6.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins");
    config2.resolve.alias["sw-plugins"] = swPluginsDirectory;
    if (ctx.isClient && !ctx.isDev) {
      config2.optimization.splitChunks.cacheGroups.commons.minChunks = 2;
    }
  });
  ...
  moduleObject.options.build.babel.presets = ({ isServer }) => {
    return [
      [
        path6.join(moduleObject.options.rootDir, "node_modules", "@nuxt", "babel-preset-app"),
        {
  ...
  if (!moduleObject.options.dev) {
    moduleObject.nuxt.hook("build:done", async (builder) => {
      const sourceDir = path6.join(TARGET_SOURCE, "static");
      const destinationDir = path6.join(builder.options.rootDir, "static");
      await fse2.copy(sourceDir, destinationDir);
      const temporaryShopwarePwaDumpFile = path6.join(moduleObject.options.rootDir, ".shopware-pwa", "pwa-bundles.json");
      if (fse2.existsSync(temporaryShopwarePwaDumpFile)) {
        try {
          fse2.removeSync(temporaryShopwarePwaDumpFile);
        } catch (error) {
...
var ShopwarePWAModule = async function(moduleOptions) {
