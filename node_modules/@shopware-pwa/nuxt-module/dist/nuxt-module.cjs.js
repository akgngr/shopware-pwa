...
var require_delayed_stream = __commonJS({
  "node_modules/axios/node_modules/delayed-stream/lib/delayed_stream.js"(exports, module2) {
...
var require_combined_stream = __commonJS({
  "node_modules/axios/node_modules/combined-stream/lib/combined_stream.js"(exports, module2) {
    var util = require("util");
    var Stream = require("stream").Stream;
...
var require_db = __commonJS({
  "node_modules/axios/node_modules/mime-db/db.json"(exports, module2) {
    module2.exports = {
...
var require_mime_db = __commonJS({
  "node_modules/axios/node_modules/mime-db/index.js"(exports, module2) {
...
var require_defer = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/defer.js"(exports, module2) {
...
var require_async = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/async.js"(exports, module2) {
...
var require_abort = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/abort.js"(exports, module2) {
...
var require_iterate = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/iterate.js"(exports, module2) {
...
var require_state = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/state.js"(exports, module2) {
...
var require_terminator = __commonJS({
  "node_modules/axios/node_modules/asynckit/lib/terminator.js"(exports, module2) {
    var abort = require_abort();
    var async = require_async();
...
var require_parallel = __commonJS({
  "node_modules/axios/node_modules/asynckit/parallel.js"(exports, module2) {
...
var require_serialOrdered = __commonJS({
  "node_modules/axios/node_modules/asynckit/serialOrdered.js"(exports, module2) {
    var iterate = require_iterate();
    var initState = require_state();
    var terminator = require_terminator();
...
var require_serial = __commonJS({
  "node_modules/axios/node_modules/asynckit/serial.js"(exports, module2) {
...
var require_asynckit = __commonJS({
  "node_modules/axios/node_modules/asynckit/index.js"(exports, module2) {
    module2.exports = {
...
function getCompatibilityTable() {
  return __async(this, null, function* () {
    try {
      const gitHubReleasesResponse = yield import_axios.default.get(`https://raw.githubusercontent.com/vuestorefront/shopware-pwa/master/packages/commons/compatibility.json`);
    ...
    const enrichRoutes = (routes) => {
      ...
      routes.forEach((route) => {
        ...
        if (!((_a3 = route.meta) == null ? void 0 : _a3.domainId) || !domainsEntries.length) {
          domainsEntries.filter(({ url }) => {
            var _a4;
            return (_a4 = shopwarePwaConfig.shopwareDomainsAllowList) == null ? void 0 : _a4.includes(url);
...
var import_fs_jetpack4 = __toESM(require("fs-jetpack"));
...
var import_fs_jetpack5 = __toESM(require("fs-jetpack"));
...
function getTargetSourcePath(moduleObject) {
  return import_path5.default.join(moduleObject.options.rootDir, ".shopware-pwa", "source");
}
function getThemeSourcePath(moduleObject, config) {
  const directDistPath = import_path5.default.join(moduleObject.options.rootDir, config.theme, "dist");
  const directDistPathExist = import_fs_extra.default.existsSync(directDistPath);
  if (directDistPathExist)
    return directDistPath;
  const directPath = import_path5.default.join(moduleObject.options.rootDir, config.theme);
  const directPathExist = import_fs_extra.default.existsSync(directPath);
  if (directPathExist)
    return directPath;
  const nodePackageDistPath = import_path5.default.join(moduleObject.options.rootDir, "node_modules", config.theme, "dist");
  ...
  const nodePackagePath = import_path5.default.join(moduleObject.options.rootDir, "node_modules", config.theme);
...
function getProjectSourcePath(moduleObject) {
  return import_path5.default.join(moduleObject.options.rootDir, "src");
}
...
function useThemeAndProjectFiles(_0) {
  return __async(this, arguments, function* ({
    ...
    const layoutsPath = import_path5.default.join(TARGET_SOURCE, "..", "sw-plugins", "layouts");
    const layoutsExist = yield import_fs_extra.default.pathExists(layoutsPath);
    layoutsExist && (yield import_fs_extra.default.copy(layoutsPath, import_path5.default.join(TARGET_SOURCE, "layouts")));
    const pagesPath = import_path5.default.join(TARGET_SOURCE, "..", "sw-plugins", "pages");
    const pagesExist = yield import_fs_extra.default.pathExists(pagesPath);
    pagesExist && (yield import_fs_extra.default.copy(pagesPath, import_path5.default.join(TARGET_SOURCE, "pages")));
...
function onThemeFilesChanged(_0) {
  return __async(this, arguments, function* ({
    ...
    const projectFilePath = import_path5.default.join(PROJECT_SOURCE, relativePath);
    const targetFilePath = import_path5.default.join(TARGET_SOURCE, relativePath);
...
function onProjectFilesChanged(_0) {
  return __async(this, arguments, function* ({
    ...
    if (event === "unlink") {
      const baseThemeFilePath = import_path5.default.join(THEME_SOURCE, relativePath);
...
function getAllFiles(dirPath, arrayOfFiles = [], excludeHidden = true) {
  const jetpack6 = require("fs-jetpack");
...
function runModule(moduleObject, moduleOptions) {
  return __async(this, null, function* () {
    ...
    const vuexState = (_b = (_a = moduleObject.options.shopware) == null ? void 0 : _a.enableVuex) != null ? _b : false;
    ...
    moduleObject.options.alias["@"] = TARGET_SOURCE;
    moduleObject.options.alias["assets"] = import_path6.default.join(TARGET_SOURCE, "assets");
    moduleObject.options.alias["static"] = import_path6.default.join(TARGET_SOURCE, "static");
    ...
    moduleObject.addPlugin({
      src: import_path6.default.join(__dirname, "..", "plugins", "entities-parser", "entities-parser.csr.js"),
      fileName: "entities-parser.csr.js",
      mode: "client",
      options: moduleOptions
    });
    moduleObject.addPlugin({
      src: import_path6.default.join(__dirname, "..", "plugins", "entities-parser", "entities-parser.ssr.js"),
      fileName: "entities-parser.ssr.js",
      mode: "server",
      options: {}
    });
    const pluginFiles = getAllFiles(import_path6.default.join(moduleObject.options.srcDir, "plugins")).filter((filePath) => /.+.(js|ts)$/.test(filePath));
    ...
    pluginFiles.forEach((pluginPath) => {
      ...
      const pluginMode = (_b2 = (_a2 = pluginFilename.match(modePattern)) == null ? void 0 : _a2.filter((mode) => pluginModes.includes(mode) ? mode : void 0)) == null ? void 0 : _b2[0];
      moduleObject.addPlugin({
        src: pluginPath,
      ...
      console.info(`"${pluginFilename}" plugin was registered automatically in ${pluginMode != null ? pluginMode : "client&server"} mode.`);
    });
    let config = (0, import_merge2.default)({}, (0, import_composables.getDefaultApiParams)());
    try {
      const defaultsConfigBuilder = require("@shopware-pwa/nuxt-module/api-defaults").default;
    ...
    moduleObject.addPlugin({
      ...
      src: import_path6.default.join(__dirname, "..", "plugins", "api-client.js"),
      options: {
    ...
    moduleObject.addPlugin({
      src: import_path6.default.join(__dirname, "..", "plugins", "cookie-universal-nuxt.js"),
      fileName: "cookie-universal-nuxt.js",
      options: Object.assign({}, defaults, moduleOptions)
    });
    moduleObject.addPlugin({
      src: import_path6.default.join(__dirname, "..", "plugins", "composition-api.js"),
      fileName: "composition-api.js",
      options: moduleOptions
    });
    moduleObject.extendBuild((config2, ctx) => {
      const swPluginsDirectory = import_path6.default.join(moduleObject.options.rootDir, ".shopware-pwa", "sw-plugins");
    ...
    moduleObject.options.build.babel.presets = ({ isServer }) => {
      return [
        [
          import_path6.default.join(moduleObject.options.rootDir, "node_modules", "@nuxt", "babel-preset-app"),
          {
    ...
    if (!moduleObject.options.dev) {
      moduleObject.nuxt.hook("build:done", (builder) => __async(this, null, function* () {
        const sourceDir = import_path6.default.join(TARGET_SOURCE, "static");
        const destinationDir = import_path6.default.join(builder.options.rootDir, "static");
        yield import_fs_extra2.default.copy(sourceDir, destinationDir);
        const temporaryShopwarePwaDumpFile = import_path6.default.join(moduleObject.options.rootDir, ".shopware-pwa", "pwa-bundles.json");
        if (import_fs_extra2.default.existsSync(temporaryShopwarePwaDumpFile)) {
          try {
            import_fs_extra2.default.removeSync(temporaryShopwarePwaDumpFile);
          } catch (error) {
